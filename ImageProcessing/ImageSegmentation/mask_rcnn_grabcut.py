...
ap.add_argument("-c", "--confidence", type=float, default=0.5,
                help="minium probability to filter weak detections")
...
weightsPath = os.path.join([args["mask_rcnn"], "frozen_inference_graph.pb"])
...
if args["use_gpu"]:
    ...
    net.setPreferabelBackend(cv2.dnn.DNN_BACKEND_CUDA)
    net.setPreferableTarget(cv2.dnn.DNN_TARGET_CUDA)

# load our input iamge from disk and display it to our screen
...
for i in range(0, boxes.shape[2]):
    ...
    # probability is greater than the minium probability
