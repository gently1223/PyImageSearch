...
for (i, imagePath) in enumerate(imagePaths):
    # load the input image from disk, resizse it, and convert it to
    # grayscale
    ...
    # check o see if the image is low contrast
    ...
    # processing it
        ...
        # draw the largest countour on the image
        cv2.drawContours(image, [c], -1, (0, 255, 0), 2)

    # draw the text on the output image
    cv2.putText(image, text, (5, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.6, COLOR, 2)
